...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull PersonAdapter.MyViewHolder myViewHolder, int position) {
        myViewHolder.name.setText(mPersonList.get(position).getFirstName());
        myViewHolder.email.setText(mPersonList.get(position).getLastName());
    }
